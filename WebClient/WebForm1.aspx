...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" Height="258px" Width="846px" CellPadding="3" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2">
    ...
    <asp:Button ID="Button1" runat="server" BackColor="#FF9933" Height="40px" Text="Добавить" Width="200px" OnClick="Button1_Click" />
</asp:Content>
